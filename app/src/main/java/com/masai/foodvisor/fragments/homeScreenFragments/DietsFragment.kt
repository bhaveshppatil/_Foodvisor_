...
class DietsFragment : Fragment(R.layout.fragment_diets),
    com.masai.foodvisor.clickListener.dietListeners.DietClickListeners {

    private lateinit var weightLossAdapter: com.masai.foodvisor.adapter.dietAdapter.WeightLossAdapter
    private var dietModelList = mutableListOf<WeightModel>()

    private lateinit var lifestyleAdapter: com.masai.foodvisor.adapter.dietAdapter.LifestyleAdapter
    private var lifestyleModelList = mutableListOf<LifestyleModel>()

    private lateinit var fitnessAdapter: com.masai.foodvisor.adapter.dietAdapter.FitnessAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        weightLossAdapter = context?.let {
            com.masai.foodvisor.adapter.dietAdapter.WeightLossAdapter(
                it,
                dietModelList,
                this
            )
        ...
        lifestyleAdapter = context?.let {
            com.masai.foodvisor.adapter.dietAdapter.LifestyleAdapter(
                it,
                lifestyleModelList,
                this
            )
        ...
        fitnessAdapter = context?.let {
            com.masai.foodvisor.adapter.dietAdapter.FitnessAdapter(
                it,
                fitnessModelList,
                this
            )
